...
if(isset($_SESSION['id'])) {
    ...
    $register = "SELECT * FROM adminreg WHERE id = $id";
		...
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="url" class="form-control" id="website" value="<?php echo $reg_row['password']; ?>" name="password" placeholder="Password">
				</div>
			</div>
			<?php } ?>
		</div>
		...
		<div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-5">
				<div class="text-right">
                    <a href="dash.php" class="btn btn-secondary"  type="button">Cancel</a>
                    <a href="adminprofile.php" class="btn btn-primary" name="up-btn" type="button">Edit</a>
