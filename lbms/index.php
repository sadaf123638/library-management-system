...
<html lang="en">
  ...
  <div class="container-fluid">
    <span class="navbar-brand mb-0 h1">Libray Management System</span>
  </div>
</nav>
    </div>
    <div class="container">
                ...
                <div class="card">
                    <form method="post" autocomplete="off">
                        ...
                        <div class="mb-3">
                         ...
                         <input type="tel" class="form-control" name="number" id="exampleInputContact" aria-describedby="emailHelp">
                          </div>
