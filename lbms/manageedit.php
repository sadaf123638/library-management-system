...
$bprice = $_POST['bprice'];
    ...
    $query_update = "UPDATE addbook SET bid='$bid', bname='$bname', baid='$baid', bcid='$bcid', bnum='$bnum', bprice='$bprice' WHERE id='$update_id' ";
...
$id = $_GET['id'];    
$register_query = "SELECT * FROM addbook WHERE id='$id' ";
