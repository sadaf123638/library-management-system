...
$number = $_POST['number'];
    ...
    $query_update = "UPDATE regdb SET name='$name',  email='$email', pass='$pass', number='$number' WHERE id='$update_id' ";
...
$register_query = "SELECT * FROM regdb WHERE id='$id' ";
        ...
        <div class="col-md-10 mt-3">
            <div class="card">
                ...
                <form action="" method="post">
                 ...
                 <div class="form-group">
                 <label>Phone</label>
                 <input type="tel" class="form-control" id="exampleInputEmail1" name="number" aria-describedby="emailHelp" value="<?php echo $row['number']; ?>">
                </div>
